...
3. **Full capability reference**: [`docs/capabilities.md`](https://github.com/jyunming/FrontierInsight/blob/main/docs/capabilities.md) — the 20-node DAG, every YAML field with defaults, knowledge layer internals, output kinds.

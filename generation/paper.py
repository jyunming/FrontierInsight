...
_LATEX_UNICODE_REPLACEMENTS: dict[str, str] = {
    ...
    "Ψ": r"\ensuremath{\Psi}",
    "Ω": r"\ensuremath{\Omega}",
    # Sets, logic and relations: a model writes "R0 ∈ {0.9, 1.5}" in prose, and pdflatex stopped on the first "∈"
    # (every run of one model; the PDF fell back to another renderer and the page-limit check was skipped).
    "∈": r"\ensuremath{\in}",
    "∉": r"\ensuremath{\notin}",
    "∋": r"\ensuremath{\ni}",
    "⊂": r"\ensuremath{\subset}",

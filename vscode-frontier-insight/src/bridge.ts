...
export class Bridge {
    ...
    attachChild(child: ChildProcess, rawLineSink?: (line: string) => void): void {
        ...
        const NODE_PATTERN = /\[(clarify|ideate|literature|plan|design|design_self_critique|implement_outline|implement|execute|execute_reflect|analyze|cross_check|evidence_gate|write|claim_check|review|human_feedback|auto_collect_data|wait_for_data|data_load|web_plots|web_figures)\]\s*(.*)$/;
